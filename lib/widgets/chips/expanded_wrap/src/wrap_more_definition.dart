...
enum WrapMoreAlignment {
  ...
  (double leadingSpace, double betweenSpace) distributeSpace(
    ...
    return switch (this) {
      ...
      WrapMoreAlignment.end =>
        WrapMoreAlignment.start.distributeSpace(freeSpace, itemSpacing, itemCount, !flipped),
      WrapMoreAlignment.spaceBetween when itemCount < 2 =>
        WrapMoreAlignment.start.distributeSpace(freeSpace, itemSpacing, itemCount, flipped),
      WrapMoreAlignment.center => (freeSpace / 2.0, itemSpacing),
      WrapMoreAlignment.spaceBetween => (0, freeSpace / (itemCount - 1) + itemSpacing),
