...
class ExpandedWrap extends StatefulWidget {
  ...
  /// Try to avoid using [WrapMoreNearAlignment.stretch] as much as possible, as it
...
class _ExpandedWrapState extends State<ExpandedWrap> {
  ExpandedWrapController get effectController => (_controller ??= ExpandedWrapController());
